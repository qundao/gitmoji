export const IconDefinitions = () => (
  ...
  >
    <defs>
      ...
      <symbol id="icon-git" viewBox="0 0 64 64">
        <title>git</title>
        <path 
          d="M58.944 29.506 34.494 5.056a3.6 3.6 0 0 0 -5.1 0l-5.078 5.078 6.44 6.44a4.282 4.282 0 0 1 5.424 5.46l6.2 6.2a4.286 4.286 0 1 1 -2.57 2.42l-5.79 -5.79v15.234a4.282 4.282 0 1 1 -3.528 -0.124V24.6a4.292 4.292 0 0 1 -2.33 -5.628l-6.34 -6.344L5.056 29.4a3.6 3.6 0 0 0 0 5.102l24.45 24.442a3.6 3.6 0 0 0 5.1 0L58.944 34.6a3.6 3.6 0 0 0 0 -5.102" 
          fill="#FFDD67"
        />
        <path 
          d="m24.316 10.134 6.44 6.44a4.282 4.282 0 0 1 5.424 5.46l6.2 6.2a4.286 4.286 0 1 1 -2.57 2.42l-5.79 -5.79v15.234a4.282 4.282 0 1 1 -3.528 -0.124V24.6a4.292 4.292 0 0 1 -2.33 -5.628l-6.34 -6.344" 
          fill="#fff"
        />
      </symbol>
